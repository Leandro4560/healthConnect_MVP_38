...
const RegisterForm = () => {
  ...
  const styleInput =
    "w-full h-10 bg-white rounded-lg pl-2 focus:outline focus:outline-sky-500 text-lg";
  const styleInputError =
    "w-60 text-center p-0.5 font-medium text-red-500 bg-red-100 text-lg tracking-wide";
  ...
  return (
    <form
      ...
      <button
        type="submit"
        className="w-64 h-10 text-lg tracking-wide bg-primary-500 text-white rounded-lg">
        Registrate
      </button>
    </form>
  );
